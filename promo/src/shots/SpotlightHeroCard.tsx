...
const INK = '#0f172a';
const AMBER = '#0d9488';
const SLOT_AMBER = '#14b8a6';
const BEAM_CORE = 'rgba(204,251,241,0.98)';
const PATCH = '#e2e8f0';
  ...
  return (
    <AbsoluteFill style={{backgroundColor: '#0b1220'}}>
      <AbsoluteFill style={{ opacity: macroIn }}>
        ...
        <AbsoluteFill
          style={{
            background: `radial-gradient(${poolRx}px ${poolRy}px at ${spotX}% ${spotY}%, rgba(45,212,191,0.28), rgba(45,212,191,0.08) 45%, rgba(11,18,32,${vignette * spotOn}) 100%)`,
            pointerEvents: 'none',
            opacity: spotOn,
          }}
        />
        <AbsoluteFill
          style={{
            background: `radial-gradient(300px 220px at ${spotX - 6}% ${spotY + 10}%, rgba(153,246,228,0.16), transparent 70%)`,
            pointerEvents: 'none',
            opacity: spotOn * 0.7,
          }}
        />
