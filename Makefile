...
demo:
	...
	@echo "Headers: -H 'X-Tenant-Id: 11111111-1111-1111-1111-111111111111' -H 'X-Roles: admin'"
	@echo "List users:"
	@echo "  curl -s 'http://localhost:8000/api/v1/users' -H 'X-Tenant-Id: 11111111-1111-1111-1111-111111111111' -H 'X-Roles: admin' | jq"
